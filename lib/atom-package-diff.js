...
exports.sync = sync;
exports.syncWithLocal = syncWithLocal;
...
function syncWithLocal() {
  ...
  try {
    for (var _iterator3 = stats.only_in_apm[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  try {
    for (var _iterator4 = stats.only_in_local[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
function syncWithRemote() {
  ...
  try {
    for (var _iterator5 = stats.only_in_local[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
  ...
  try {
    for (var _iterator6 = stats.only_in_apm[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
